<%@ Page Language="C#" AutoEventWireup="true" EnableSessionState="True"
    CodeBehind="WebForm1.aspx.cs" Inherits="Webforms.WebForm1" %>
        ...
        <div style="display: flex; justify-content: flex-start">
            <div style="max-width: 350px; text-align: left; border: 1px solid black">
                <div>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" ControlToValidate="TextBox5" runat="server" ForeColor="Red" ErrorMessage="Enter Age "></asp:RequiredFieldValidator>
                    <br />
                    ...
                    <p>
                        ...
                        <asp:CompareValidator ID="CompareValidatorDateofbirth"
                            ...
                            ControlToValidate="txtDateAvailable" ValueToCompare="01/01/2012"
            ...
            <div style="width: 400px; border: 1px solid black">
                ...
                <div>
                    ...
                    <br />
                    <asp:Button ID="Button22" runat="server" Text="Throw Exception and Email" OnClick="Button22_Click" />                </div>
                    <br />
                                <asp:Button ID="Button23" runat="server" Text="Write Trace" OnClick="Button23_Click" />                </div>
